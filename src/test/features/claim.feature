Feature: Claim for Payment - Login and happy path journey
  ...
  Scenario: The provider/User logs in and land on Claims home page
    ...
    And I should see the following navigation
      | Tab              |
      | Your submissions |
      | Matter starts    |
      | Search           |
  ...
  Scenario: The provider/User logs in and chooses how to upload evidence page
    ...
    Then I should see the heading "How do you want to upload your evidence?"
    When I select "Associated to specific line" radio button for "How do you want to upload your evidence?"
